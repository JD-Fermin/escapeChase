...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function handleKeyDown(event) {
    ...
    // let test = Utils.detectPlayerObjectInteraction(updatedObjects, testPlayer) ? Utils.detectPlayerObjectInteraction(updatedObjects, testPlayer).pos : null;
    // console.log(test, event.code === "KeyE")
